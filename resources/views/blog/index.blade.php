...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
            <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Amazing Stories</h2>
            <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Amazing stories that will inspire your life.</p>
        </div>
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <!-- <div class="blog-post">
                ...
                <p><small>Posted on {{ $blog['date_post'] }} by {{ $blog['username'] }}</small></p>
            </div> -->
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center mb-5 text-gray-500">
                    ...
                    <span class="text-sm">Posted on {{ $blog['date_post'] }}</small></span>
                </div>
                <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">{{ $blog['title'] }}</a></h2>
                <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{{ $blog['blog_content'] }}</p>
                <div class="flex justify-between items-center">
                    ...
                    <a href="/blog/detailblog" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                        Read more
...
<!-- <div>
    ...
    <p>This is All of Blog for you</p>
    <a href="/">Home |</a>
    <a href="/blog">Blog |</a>
    <a href="/blog/tag">Tags |</a>
    <a href="/blog/category">Categorys</a>     -->
